/*
 * This is a modified version of the orignal from https://github.com/SIDN/client_dnssec_check
 *
 * DNSSEC check script
 * 
...
sidn_dnssec.icon_checking = "nodec icon-spin"
sidn_dnssec.icon_success = "nodec icon-ok"
sidn_dnssec.icon_failed = "nodec icon-nok"
sidn_dnssec.txt_checking = "Checking DNSSEC..."
...
// Change the icon that is shown if there is DNSSEC validation
function sidn_dnssec_set_success_icon(icon) {
	sidn_dnssec.icon_success = icon;
}
...
// Change the icon that is shown if there is *no* DNSSEC validation
function sidn_dnssec_set_failure_icon(icon) {
	sidn_dnssec.icon_failed = icon;
}
...
function sidn_dnssec_set_checking_icon(icon) {
	sidn_dnssec.icon_checking = icon;
}
...
function sidn_dnssec_pixel_loaded() {
	...
	sidn_dnssec_set_status(sidn_dnssec.icon_failed,
...
function sidn_dnssec_pixel_not_loaded() {
	sidn_dnssec_set_status(sidn_dnssec.icon_success,
...
function sidn_dnssec_validation_check() {
	...
	sidn_dnssec_set_status(sidn_dnssec.icon_checking,
